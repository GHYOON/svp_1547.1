<scriptConfig name="VW_2" script="VW">
  <params>
    <param name="vw.test_2_tr" type="float">2.0</param>
    ...
    <param name="vw.test_3" type="string">Disabled</param>
    ...
    <param name="vw.test_2" type="string">Enabled</param>
