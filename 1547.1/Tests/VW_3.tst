<scriptConfig name="VW_3" script="VW">
  <params>
    <param name="vw.test_3_tr" type="float">2.0</param>
    ...
    <param name="vw.test_1" type="string">Disabled</param>
    <param name="vw.test_2" type="string">Disabled</param>
    ...
    <param name="vw.test_3" type="string">Enabled</param>
    <param name="eut_vw.sink_power" type="string">No</param>
    <param name="vw.mode" type="string">Normal</param>
    <param name="vw.vw_curve_units" type="string">Percentage</param>
