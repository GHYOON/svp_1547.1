<scriptConfig name="VV_1" script="VV">
  <params>
    ...
    <param name="eut.v_low" type="float">0.0</param>
    <param name="eut.var_rated" type="float">0.0</param>
    <param name="eut.v_high" type="float">0.0</param>
    <param name="eut.s_rated" type="float">0.0</param>
    <param name="vv.test_1_t_r" type="float">1.0</param>
